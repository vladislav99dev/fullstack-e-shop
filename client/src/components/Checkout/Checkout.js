      ...
      <div className=" bg-white py-10 flex-column lg:grid lg:grid-cols-2 h-full">
        <form onSubmit={checkoutHandler} className="py-6 lg:py-10">
          ...
          <div className="flex justify-between">
            <p className="uppercase text-2xl  ml-5 lg:ml-10 mb-2 font-bold text-gray-600">
              Shipping address
            </p>
            {user.email ? (
              <button
                onClick={fillFormWithUserInfo}
                className="text-sm mr-5 lg:mr-10 mt-2 italic font-bold text-white rounded-md mb-2 bg-[#00df9a] sm:py-2"
              >
                Do you want to use profile information?
              </button>
            ) : null}
          </div>
          ...
          <div className="mb-6 flex 2xl:w-[97.5%] mr-[4%] lg:mr-0 ">
            <input
              className="border-2 py-2 w-[50%]  ml-5 lg:ml-10 rounded-lg"
              type="text"
              name="firstName"
              id="firstName"
          ...
          <input
            className="border-2 py-2 w-[93.5%]  ml-5 lg:ml-10 mb-6 rounded-lg"
            type="text"
            name="email"
            id="email"
            placeholder="Email"
          ...
          <div className="flex 2xl:w-[97.5%] mr-[4%] lg:mr-0">
            <input
              className="border-2 py-2 w-[50%]  ml-5 lg:ml-10 mb-6 rounded-lg"
              type="text"
              name="state"
              id="state"
              placeholder="State *"
          ...
          />
          <button
            className=" ml-5 lg:ml-10 py-2 w-[50%] border-2 border-[#00df9a] rounded-lg mb-4 bg-[#00df9a] text-white font-bold italic"
            type="submit"
          >
            Submit
          </button>
        ...
        <div className="order-first lg:order-last">
          <div className="mt-20 ml-10 mr-10  bg-gray-100 rounded-lg">
            <p className="uppercase text-xl font-bold  mt-10 text-center py-4 text-gray-600 border-b-2 border-gray-400">
              Order Summary
            </p>
            ...
            {user.email
              ? user.cart.map((product) => (
                  <div
                    ...
                    className="flex justify-between py-2 border-b-2 border-gray-300"
                  >
                    <p className="ml-5 text-md font-bold  text-gray-400">
                      {product._id.name}
                    </p>
                    <div>
            ...
            <div className="flex justify-between py-4">
              ...
              <p className="mr-10 text-xl font-bold text-gray-800">{`$${totalPrice.toFixed(
                2
              )}`}</p>
            </div>
          </div>
          <div className=" flex justify-around border-2 border-[#00df9a] h-[180px] mt-10 ml-10 mr-10 rounded-md">
            <GiTigerHead
              className="ml-4 mt-10 2xl:ml-32"
              size={100}
              color={"#00df9a"}
            />
            <div className="ml-4 mt-10 2xl:mr-32">
              <p className="italic text-gray-500 lg:text-center">
                We are glad you choose us!
              </p>
              <p className="text-center italic text-gray-500">
                You will get a free shipping from your next order!
              </p>
              <p className="italic text-gray-500">Best regards, </p>
              <p className="text-end text-xl font-bold uppercase italic text-[#00df9a]">
