...
const PersonalInfo = () => {
    ...
    return (
        <div className="flex justify-center">
            <div className="w-[15%] border-4 border-[#00df9a]">
                <button onClick={btnClickHandler.bind(null,"edit")} className="py-4 border-b-4 border-[#00df9a] w-full text-left font-extrabold text-[#28282B]">Edit Profile</button>
                <button onClick={btnClickHandler.bind(null,"changePassword")} className="py-4 border-b-4 border-[#00df9a] w-full text-left font-extrabold text-[#28282B]">Change Password</button>
